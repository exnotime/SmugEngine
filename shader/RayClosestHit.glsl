...
layout(binding = 2) buffer normals { vec3 g_VertexNormals[]; };
layout(binding = 3) buffer indexBuffer { uint g_IndexBuffer[]; };
layout(binding = 4) buffer instanceOffsets { uint g_InstanceIndexOffsets[]; };
