...
#pragma endregion
	...
	static vk::PipelineDepthStencilStateCreateInfo GetDefaultDepthStencilstate() {
	...
	static vk::PipelineRasterizationStateCreateInfo GetDefaultRasterState() {
	...
	static vk::PipelineColorBlendStateCreateInfo GetDefaultColorBlendState() {
	...
	static vk::PipelineColorBlendAttachmentState GetDefaultColorBlendAttachmentState() {
