...
class FrameBuffer {
  public:
	...
	//Getters
	Vector<vk::Image>& GetImages() {
		return m_Images;
	}
	Vector<vk::ImageView>& GetViews() {
		return m_ImageViews;
	}
	Vector<vk::Format>& GetFormats() {
		return m_Formats;
	}
	Vector<vk::ImageLayout>& GetLayouts() {
		return m_CurrentLayouts;
	}
	Vector<vk::DescriptorImageInfo>& GetDescriptors() {
